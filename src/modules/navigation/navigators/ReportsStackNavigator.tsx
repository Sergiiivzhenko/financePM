...
import {OutcomeCategoriesReport} from "../../reports/screens/OutcomeCategoriesReport";
...
export const ReportsStackNavigator = () => (
    <Stack.Navigator>
        ...
        <Stack.Screen name="OutcomeCategoriesReport" component={OutcomeCategoriesReport} options={{title: 'Outcome by Categories'}}/>
